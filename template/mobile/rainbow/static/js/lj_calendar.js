...
//          .animate({left: offset_l + 16, top: offset_t, opacity: 1});
    ...
    renderDOM: function () { // 渲染DOM
      ...
      var _titleStr = '<a href="#" class="title"></a>'+
                      '<div class="arrow">'+
                        '<span class="arrow-prev"><img src="/template/mobile/rainbow/static/image/lj_rl_l.png" /></span>'+
                        '<span class="arrow-next"><img src="/template/mobile/rainbow/static/image/lj_rl_r.png" /></span>'+
                      '</div>';
      var _weekStr = '<li class="item item1 item2">日</li>'+
                      '<li class="item item1">一</li>'+
                      '<li class="item item1">二</li>'+
                      '<li class="item item1">三</li>'+
                      '<li class="item item1">四</li>'+
                      '<li class="item item1">五</li>'+
                      '<li class="item item1">六</li>';
      var _dateStr = '';
